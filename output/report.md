...
- Predicted exception records: 43
- Correctly flagged exceptions: 29
...
| Decoy | 50.00% | 60.00% | 72.73% | correctly deferred, not auto-resolved to decoy |
...
| setl_0062 | settlement | settlement present, bank credit missing (payout may be in transit) |
...
_Grouped by relatedIds for display (31 groups from 43 per-record flags). Scoring still uses per-record exceptions._
