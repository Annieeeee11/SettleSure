...
import { CLI_CMD, CLI_PREVIEW, CLI_WINDOW, WORDMARK } from "@/lib/landingContent";
...
export default function CliPreview() {
  ...
  return (
    <TerminalChrome>
      <div className="overflow-x-auto p-4 font-mono text-[0.62rem] leading-relaxed text-zinc-400 sm:p-5 sm:text-[0.68rem]">
