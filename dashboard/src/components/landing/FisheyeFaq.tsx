...
function FaqRow({
  ...
  return (
    <motion.div
      ...
      className="relative min-h-[3.75rem] rounded-2xl border border-[var(--card-border)] bg-[var(--surface)] px-6 py-4 shadow-[var(--shadow-raised-sm)] sm:min-h-[4rem] sm:px-7 sm:py-5"
    >
